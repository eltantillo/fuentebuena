...
class HelpdeskTicket(models.Model):
    ...
    # === Visibility gates mirrored from helpdesk.team ===
    show_gnv_next_ruling_date = fields.Boolean(related='team_id.show_gnv_next_ruling_date')
    show_tentative_delivery_date = fields.Boolean(related='team_id.show_tentative_delivery_date')
    show_pound_exit_date = fields.Boolean(related='team_id.show_pound_exit_date')
    show_claim_status = fields.Boolean(related='team_id.show_claim_status')
    show_tracking_log = fields.Boolean(related='team_id.show_tracking_log')
    show_advisor_id = fields.Boolean(related='team_id.show_advisor_id')
    show_info_evidence = fields.Boolean(related='team_id.show_info_evidence')
    show_specific_request = fields.Boolean(related='team_id.show_specific_request')
    show_capture_evidence = fields.Boolean(related='team_id.show_capture_evidence')
    show_payment_voucher_id = fields.Boolean(related='team_id.show_payment_voucher_id')
    show_amount = fields.Boolean(related='team_id.show_amount')
    show_date = fields.Boolean(related='team_id.show_date')
    show_bank_id = fields.Boolean(related='team_id.show_bank_id')
    show_reference_cie = fields.Boolean(related='team_id.show_reference_cie')
    show_extension_folio = fields.Boolean(related='team_id.show_extension_folio')
    show_issue_description = fields.Boolean(related='team_id.show_issue_description')
    show_location = fields.Boolean(related='team_id.show_location')
    show_customer_availability = fields.Boolean(related='team_id.show_customer_availability')
    show_photos_video_evidence = fields.Boolean(related='team_id.show_photos_video_evidence')
    show_event_datetime = fields.Boolean(related='team_id.show_event_datetime')
    show_event_narrative = fields.Boolean(related='team_id.show_event_narrative')
    show_accident_photos = fields.Boolean(related='team_id.show_accident_photos')
    show_insurance_authority_report = fields.Boolean(related='team_id.show_insurance_authority_report')
    show_gps_location = fields.Boolean(related='team_id.show_gps_location')
    show_procedure_document = fields.Boolean(related='team_id.show_procedure_document')
    show_fleet_customer_plaza_id = fields.Boolean(related='team_id.show_fleet_customer_plaza_id')
    show_fine_evidence = fields.Boolean(related='team_id.show_fine_evidence')
    show_origin_destination = fields.Boolean(related='team_id.show_origin_destination')
    show_reason = fields.Boolean(related='team_id.show_reason')
    show_trip_duration = fields.Boolean(related='team_id.show_trip_duration')
    show_app_trip = fields.Boolean(related='team_id.show_app_trip')
    show_debt_claim_extension_validation = fields.Boolean(related='team_id.show_debt_claim_extension_validation')
    show_legal_name = fields.Boolean(related='team_id.show_legal_name')
    show_fiscal_zip = fields.Boolean(related='team_id.show_fiscal_zip')
    show_fiscal_regime = fields.Boolean(related='team_id.show_fiscal_regime')
    show_fiscal_usage = fields.Boolean(related='team_id.show_fiscal_usage')
    show_fiscal_proof_document = fields.Boolean(related='team_id.show_fiscal_proof_document')
    show_requested_period = fields.Boolean(related='team_id.show_requested_period')
    show_referral_code = fields.Boolean(related='team_id.show_referral_code')
    show_promotion = fields.Boolean(related='team_id.show_promotion')
    show_delivery_evidence_date = fields.Boolean(related='team_id.show_delivery_evidence_date')
    show_fleet_customer_producto_id = fields.Boolean(related='team_id.show_fleet_customer_producto_id')
    show_contract_end_date = fields.Boolean(related='team_id.show_contract_end_date')
    show_balance_amount = fields.Boolean(related='team_id.show_balance_amount')
    show_customer_intent = fields.Boolean(related='team_id.show_customer_intent')
    show_fleet_vehicle_id = fields.Boolean(related='team_id.show_fleet_vehicle_id')
    show_case_status_confirmed = fields.Boolean(related='team_id.show_case_status_confirmed')
    show_payment_management_result = fields.Boolean(related='team_id.show_payment_management_result')
    show_final_response_sent = fields.Boolean(related='team_id.show_final_response_sent')
    show_closed_stage_id = fields.Boolean(related='team_id.show_closed_stage_id')
    show_invoice_corrected = fields.Boolean(related='team_id.show_invoice_corrected')
    show_correction_commitment_date = fields.Boolean(related='team_id.show_correction_commitment_date')
    show_closure_evidence = fields.Boolean(related='team_id.show_closure_evidence')
    show_corrected_info_channel = fields.Boolean(related='team_id.show_corrected_info_channel')
    show_commercial_responsible_notified = fields.Boolean(related='team_id.show_commercial_responsible_notified')
    show_procedure_validated = fields.Boolean(related='team_id.show_procedure_validated')
    show_response_instruction_document = fields.Boolean(related='team_id.show_response_instruction_document')
    show_follow_up_responsible_id = fields.Boolean(related='team_id.show_follow_up_responsible_id')
    show_benefit_validated = fields.Boolean(related='team_id.show_benefit_validated')
    show_benefit_request_result = fields.Boolean(related='team_id.show_benefit_request_result')
    show_benefit_rejection_reason = fields.Boolean(related='team_id.show_benefit_rejection_reason')
    show_termination_requirements_confirmed = fields.Boolean(related='team_id.show_termination_requirements_confirmed')
    show_termination_next_step = fields.Boolean(related='team_id.show_termination_next_step')
    show_maintenance_appointment_datetime = fields.Boolean(related='team_id.show_maintenance_appointment_datetime')
    show_diagnosis_confirmed = fields.Boolean(related='team_id.show_diagnosis_confirmed')
