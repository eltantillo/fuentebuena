...
class ReportAssetTemplateLabel2x7(models.AbstractModel):
    _name = 'report.sdlc_asset_management.report_assetlabel2x7'
...
class ReportAssetTemplateLabel4x7(models.AbstractModel):
    _name = 'report.sdlc_asset_management.report_assetlabel4x7'
...
class ReportAssetTemplateLabel4x12(models.AbstractModel):
    _name = 'report.sdlc_asset_management.report_assetlabel4x12'
...
class ReportAssetTemplateLabel4x12NoPrice(models.AbstractModel):
    _name = 'report.sdlc_asset_management.report_assetlabel4x12noprice'
...
class ReportAssetTemplateLabelDymo(models.AbstractModel):
    _name = 'report.sdlc_asset_management.report_assetlabel_dymo'
...
class ReportAssetTemplateLabelCustom(models.AbstractModel):
    _name = 'report.sdlc_asset_management.report_assetlabel_custom'
