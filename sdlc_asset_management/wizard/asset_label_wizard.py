...
class AssetLabelLayout(models.TransientModel):
    ...
    def _prepare_report_data(self):
        ...
        if self.print_format == 'custom':
            ...
            xml_id = 'sdlc_asset_management.report_asset_template_label_custom'
        elif self.print_format == 'dymo':
            xml_id = 'sdlc_asset_management.report_asset_template_label_dymo'
        elif 'x' in self.print_format:
            xml_id = 'sdlc_asset_management.report_asset_template_label_%sx%s' % (self.columns, self.rows)
